    ...
    <div class="container">
      <div class="row"> 
        ...
        <div class="col-sm-9"> 
          ...
          <section> <span class="sale-tag font-montserrat"> For Sales</span> <span class="sale-tag price font-montserrat"> $3,586,996</span> </section>
          <p>Sometimes you want to go where everybody knows your name. And they're always glad you came. Movin' on up to the east side. We finally got a piece of the pie. All of them had hair of gold like their mother the youngest one in curls. The weather started getting rough  the tiny ship was tossed. If not for the courage of the fearless crew the Minnow would be lost. the Minnow would be lost.</p>
          ...
          <section class="info-property agents-info">
            ...
            <div class="inner"> 
              <!--======= AGENT DETAILS =========-->
              <div class="row">
                <div class="col-sm-3"> <img class="img-responsive" src="images/agent-3.jpg" alt="" > </div>
                <div class="col-sm-9">
                  ...
                  <p>Maybe you and me were never meant to be. But baby think of me once in awhile. I'm at WKRP in Cincinnati. Boy the way Glen Miller played. Songs that made the hit parade. Guys like us we had it made. Those were the days.</p>
          ...
          <ul class="row">
            ...
            <li class="col-sm-4"> 
              ...
              <section> 
                ...
                <!--======= HOME DETAILS =========-->
                <div class="detail-sec"> <a href="#." class="font-montserrat">sweet home for small family</a> <span class="locate"><i class="fa fa-map-marker"></i> Boston,USA</span> <span class="price-bg  font-montserrat">$ 256,596</span> <a href="#." class="btn">more details</a> </div>
              </section>
            </li>
