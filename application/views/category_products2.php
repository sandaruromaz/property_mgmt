    ...
    <div class="row"> 
      ...
      <div id="sidebar" class="col-lg-3 col-md-3 col-sm-3 padbot50"> 
        ...
        <div class="sidepanel widget_brands">
          ...
          <label for="categorymanufacturer1" class="brands">REBORN<span></span></label>
          <input type="checkbox" id="categorymanufacturer2" name="brands[]" value="nolimit"/>
          <label for="categorymanufacturer2" class="brands" >Nolimit <span></span></label>
      ...
      <div class="col-lg-9 col-sm-9 padbot20"> 
        ...
        <div class="sorting_options clearfix"> 
          ...
          <div class="count_tovar_items">
            <p><?php echo str_replace('-',' ',ucwords($this->uri->segment(3))); ?></p>
            <span><?php echo $product_count; ?> Items</span> </div>
          <!-- //COUNT TOVAR ITEMS --> 
        ...
        <div class="row shop_block"> 
          ...
          <?php 
						...
						foreach ($cresults as $product)
						{
							...
							?>
          <div class="tovar_wrapper col-lg-4 col-md-4 col-sm-6 col-xs-6 col-ss-12 padbot40 <?php echo $product->brand_name; ?>">
            <div class="tovar_item clearfix">
              <div class="tovar_img">
                ...
                <div class="tovar_item_btns">
                  <a class="open-project tovar_view" href="<?php echo base_url();?>index.php/shop/product_details/<?php echo $product->product_id; ?>/<?php echo url_title(strtolower($product->product_name)); ?>" >view</a>
              ...
              <a class="tovar_title" href="<?php echo base_url();?>index.php/shop/product_details/<?php echo $product->product_id; ?>/<?php echo url_title(strtolower($product->product_name)); ?>" ><?php echo $product->product_name; ?> <?php echo $product->brand_name; ?></a> <span class="tovar_price">LKR: <?php echo $product->price; ?></span> </div>
