...
<?php 
$image_array[0]=$product['img1'];
if($product['img2']!=""){
$image_array[1]=$product['img2'];
}
if($product['img3']!=""){
$image_array[2]=$product['img3'];
}
if($product['img4']!=""){
$image_array[3]=$product['img4'];
}
// print_r($image_array);
// $image_height = "200";
// $image_width = "200";
...
?>
                <div class="row">
                                ...
                                <div class="carousel slide" id="myCarousel">
                                    ...
                                    <?php foreach ($image_array as $gkey=> $galllery) {
                                     $active = ($gkey == 0) ? " active" : ""; ?>
                                        ...
                                        $thumb_galllery_image = base_url(). "assets/timthumb.php?src=" . $large_galllery_image . "&h=" . $image_height . "&w=" . $image_width . "&zc=1";
                                      ?>
                                        <?php
                                        if($galllery_image!="") {?>
                 ...
                 <div class="row hidden-phone" id="slider-thumbs">
                    <div class="col-xs-12 col-md-12 col-sm-12 col-md-12">
                        ...
                        <?php foreach ($image_array as $gkey=> $galllery) {
                         $active = ($gkey == 0) ? " active" : ""; ?>
                            <li class=" col-xs-6 col-sm-2 col-md-2">
                                <a class="thumbnail" id="carousel-selector-<?php echo $gkey ?>">
                                <?php 
                                $image_height = "100";
                                $image_width = "170";
                                $galllery_image=$galllery;
                                ...
                                <!-- <img class="img-rounded" src="<?php echo $large_contact1_image; ?>" height="<?php echo $image_height; ?>" width="<?php echo $image_width; ?>" /> -->
                                <?php }?> 
