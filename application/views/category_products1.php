        ...
        <div class="row shop_block"> 
          ...
          <div class="tovar_wrapper col-lg-4 col-md-4 col-sm-6 col-xs-6 col-ss-12 padbot40">
            <div class="tovar_item clearfix">
              ...
              <div class="tovar_description clearfix"> <a class="tovar_title" href="product-page.html" ><?php echo $product->product_name; ?> </a> <span class="tovar_price">LKR: <?php echo $product->price; ?></span> </div>
