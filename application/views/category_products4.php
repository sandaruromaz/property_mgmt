            ...
            <div class="tovar_item clearfix">
              <div class="tovar_img">
                ...
                <div class="tovar_item_btns">
                  <div class="open-project-link"><a class="open-project tovar_view" href="%21projects/men/1.html" ><span>quick</span> view</a></div>
              ...
              <a class="tovar_title" href="product-page.html" ><?php echo $product->product_name; ?> <?php echo $product->brand_name; ?></a> <span class="tovar_price">LKR: <?php echo $product->price; ?></span> </div>
