		...
		<div class="page-content">						
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					System Users<small></small> <a href="#addnewModal" data-toggle="modal" class="btn green" style="float:right" >Add New System User </a>
					<div id="addnewModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<p>
                                        <form role="form" class="form-horizontal"  action="<?php echo base_url(); ?>index.php/Admin/useradd" method="post" onsubmit="return addnewuservalidation()">
                                        <div class="form-body">
                                        
                                        <h4 class="modal-title">User Role Information</h4><hr /><br />
                                        <div class="form-group">
                                         
										<label class="col-md-4 control-label">User Role Name<font class="required">* </font></label>
										<div class="col-md-6">
                                        <div class="has-error" >
                                       ...
                                       <h4 class="modal-title">User Login Information</h4><hr /><br /> 
                                       <div class="form-group">
                                                <label class="col-md-4 control-label">Email<font class="required">* </font></label>
                                                <div class="col-md-6">
                                                 <div class="has-error" >
                                                    <input type="text" placeholder="Enter email address" value="" class="form-control" name="email" id="email">
                                                <span class='error' style=" font-size:14px"></span> </div>
                                                </div>
                                         </div>     
                                         <div class="form-group">
                                                <label class="col-md-4 control-label">Password<font class="required">* </font></label>
                                                <div class="col-md-6">
                                                 <div class="has-error" >
                                                    <input type="password" placeholder="Enter password" value="" class="form-control" name="password" id="pass">
                                                <span class='error' style=" font-size:14px"></span> </div>
                                                </div>
                                         </div>  
                                           <div class="form-group">
                                                <label class="col-md-4 control-label">Confirm Password<font class="required">* </font></label>
                                                <div class="col-md-6">
                                                 <div class="has-error" >
                                                    <input type="password" placeholder="Enter confirm password" value="" class="form-control" name="cpassword" id="cpass" >
                                                <span class='error' style=" font-size:14px"></span> </div>
                                                </div>
                                         </div> 
                                         <h4 class="modal-title">User Other Information</h4><hr /><br />
                                         <div class="form-group">
                                       ...
                                       <div class="form-group">
                                         ...
                                         <div class="form-group">
                                                <label class="col-md-4 control-label">Address Line 1<font class="required">* </font></label>
                                                <div class="col-md-6">
                                                 <div class="has-error" >
                                                    <input type="text" placeholder="Enter address line 1" value="" class="form-control" name="add1" id="add">
                                                <span class='error' style=" font-size:14px"></span> </div>
                                                </div>
                                         </div>
                                         <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                 <div class="has-error" >
                                                    <input type="text" placeholder="Enter address line 2" value="" class="form-control" name="add2" id="add2">
                                                <span class='error' style=" font-size:14px"></span> </div>
                                                </div>
                                         </div>
										<div class="form-group">
                                                <label class="col-md-4 control-label">City<font class="required">* </font></label>
                                                <div class="col-md-6">
                                                 <div class="has-error" >
                                                    <input type="text" placeholder="Enter city" value="" class="form-control" name="city" id="city">
                                                <span class='error' style=" font-size:14px"></span> </div>
                                                </div>
                                         </div>
										<div class="form-group">
                                                <label class="col-md-4 control-label">Contact No<font class="required">* </font></label>
                                                <div class="col-md-6">
                                                 <div class="has-error" >
                                                    <input type="text" placeholder="Enter contact no" value="" class="form-control" name="cno" id="cno">
                                                <span class='error'  style=" font-size:14px"></span> </div>
                                                </div>
                                         </div>
						...
						<div class="portlet-body">
							<div class="table-responsive">
								...
								<tr>
									...
									<td>
                                        <a href="#viewModal<?php echo $row['user_id'];?>" data-toggle="modal" data-original-title="VIEW" data-placement="top" class="btn default btn-xs blue tooltips" >
										<i class="fa fa-desktop"></i></a>
										<a href="#catModal<?php echo $row['user_id'];?>" data-toggle="modal" data-original-title="EDIT" data-placement="top" class="btn default btn-xs yellow tooltips" >
										<i class="fa fa-edit"></i></a>
										<a href="#delteModal<?php echo $row['user_id'];?>" data-toggle="modal" data-original-title="REMOVE" data-placement="top" class="btn default btn-xs red tooltips" >
