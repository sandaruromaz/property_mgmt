					...
					<div class="portlet box blue-madison">
                        ...
                        <table width="20%" border="0">
		  			   ...
		  			   <tr>
                            ...
                            <td>
          <input type="text" name="test_name" class="form-control" value="<?php echo $reserve['test_id']; ?>" placeholder="" id="test_name" />
                          ...
                          <tr>
                            ...
                            <td><h5>:
                              ...
                              <input type="text" name="test_name" class="form-control" value="<?php echo $reserve['test_name']; ?>" placeholder="" id="test_name" />
              					</h5></td>
                          </tr>
                          <tr>
 				...
 				<input type="text" name="test_name" class="form-control" value="	<?php echo $reserve['test_number']; ?>" placeholder="" id="test_name" />
