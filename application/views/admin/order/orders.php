			...
			<div class="col-md-12 ">
					...
					<div class="portlet box blue-madison">
						...
						<div class="portlet-body">
							...
							<tbody>
                            <?php if(count($admin_orders)){
							foreach($admin_orders-> result_array()as $row){ ?>
							<tr>
                            	<td>
                                ...
                                <td>
                                    ...
                                    <?php } else if($row['status'] == "Delivered"){?> <span class="badge badge-success badge-roundless"> <?php } else{?>
                                ...
                                <td>
                                      <a href="<?php echo base_url(); ?>index.php/admin/order_details/<?php echo $row['order_id'];?>" data-toggle="modal" data-original-title="VIEW" data-placement="top" class="btn default btn-xs blue tooltips" >
										<i class="fa fa-desktop"></i></a>
									 <a href="#editoModal<?php echo $row['order_id'];?>" data-toggle="modal" data-original-title="QUICK EDIT" data-placement="top" class="btn default btn-xs yellow tooltips" >
										<i class="fa fa-edit"></i></a>                                     
									 <a href="#delteoModal<?php echo $row['order_id'];?>" data-toggle="modal" data-original-title="REMOVE" data-placement="top" class="btn default btn-xs red tooltips" >
                     ...
                     <?php if(count($admin_orders)){
					foreach($admin_orders-> result_array()as $row){ ?>
					<div id="editoModal<?php echo $row['order_id'];?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<p>
                                        <form role="form" class="form-horizontal"  action="<?php echo base_url(); ?>index.php/Admin/orderEdit/<?php echo $row['order_id'];?>" method="post" onsubmit="return editcatevalidation()">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <select class="form-control" name="status">
                                                      <?php $opt=array('Pending','Delivered','Canceled'); ?>
                     ...
                     <?php if(count($admin_orders)){
					foreach($admin_orders-> result_array()as $row){ ?>
					<div id="delteoModal<?php echo $row['order_id'];?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                        ...
                                        <form role="form" class="form-horizontal"  action="<?php echo base_url(); ?>index.php/Admin/orderdelete/<?php echo $row['order_id'];?>" method="post">
                                            
										<div class="modal-body">
											<p>
												 Do you want to delete "<span style="color:#06F"><?php echo $row['order_id'];?></span>" order? 
											</p>
										</div>
										<div class="modal-footer">
											<button class="btn default" data-dismiss="modal" aria-hidden="true">Close</button>
