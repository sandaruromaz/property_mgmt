			...
			<div class="col-md-12 ">
					...
					<div class="portlet box blue-madison">
						...
						<div class="portlet-body">
							...
							<tbody>
                            <?php if(count($getalltest)){
							foreach($getalltest-> result_array()as $row){ ?>
							<tr>
                            	<td>
								...
								<td>
									 <?php echo $row['test_address'];?>
								</td>
								<td>
									<?php echo $row['test_number'];?>
								</td>
								
                                
								
                                <td>
                                      <a href="<?php echo base_url(); ?>index.php/admin/test_view/<?php echo $row['test_id'];?>" data-toggle="modal" data-original-title="VIEW" data-placement="top" class="btn default btn-xs blue tooltips" >
										<i class="fa fa-desktop"></i></a>
									 <a href="<?php echo base_url(); ?>index.php/admin/test_update/<?php echo $row['test_id'];?>" data-toggle="modal" data-original-title="QUICK EDIT" data-placement="top" class="btn default btn-xs yellow tooltips" >
										<i class="fa fa-edit"></i></a>                                     
									 <a href="#delteoModal<?php echo $row['test_id'];?>" data-toggle="modal" data-original-title="REMOVE" data-placement="top" class="btn default btn-xs red tooltips" >
					...
					<div id="editoModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<p>
                                        <form role="form" class="form-horizontal"  action="<?php echo base_url(); ?>index.php/Admin/reserveedit/<?php echo $row['test_id'];?>" method="post" onsubmit="return editcatevalidation()">
                                        <div class="form-body">
...
<!-- delete -->
                     ...
                     <?php if(count($getalltest)){
					foreach($getalltest-> result_array()as $row){ ?>
					<div id="delteoModal<?php echo $row['test_id'];?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                        ...
                                        <form role="form" class="form-horizontal"  action="<?php echo base_url(); ?>index.php/Admin/testdelete/<?php echo $row['test_id'];?>" method="post">
                                            
										<div class="modal-body">
											<p>
												 Do you want to delete "<span style="color:#06F"><?php echo $row['test_id'];?></span>" order? 
											</p>
										</div>
										<div class="modal-footer">
											<button class="btn default" data-dismiss="modal" aria-hidden="true">Close</button>
                                            
                                             <input type="hidden" value="<?php echo $row['test_id'];?>" name="order_id" />
